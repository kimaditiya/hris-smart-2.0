...
<header class="main-header">
    ...
    <?= Html::a('<span class="logo-mini">HRIS</span><span class="logo-lg">' . 'HRIS SMART' . '</span>', Yii::$app->homeUrl, ['class' => 'logo']) ?>
        ...
        <div class="navbar-custom-menu">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                         <?= Html::img($image_profile,['class' => 'img-circle','alt'=>'User Image','width'=>'10px','height'=>'10px']);  ?>
                        <span class="hidden-xs"> 
                        <?= Yii::$app->ambilprofile->GetProfile() != 'none' ? Yii::$app->ambilprofile->GetProfile()->employee_name : 'None' ?>
