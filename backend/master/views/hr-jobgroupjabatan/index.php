...
/* @var $searchModel backend\master\models\HrJobgroupjabatanSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Hr Jobgroupjabatan';
...
function tombolCreate(){
      $title1 = Yii::t('app', 'New job Group');
...
/*
  ...
  */
  function tombolView($url, $model){
        ...
        $label = $icon . ' ' . $title;
        $url = Url::toRoute(['/master/hr-group/view','id'=>$model->groupjabatan_code]);
        $options1 = [
                    'id'=>'view-hrgroup-id',   
                    'data-toggle'=>"modal",
...
/*
  ...
  */
  function tombolUpdate($url, $model){
        ...
        $label = $icon . ' ' . $title;
        $url = Url::toRoute(['/master/hr-group/update','id'=>$model->groupjabatan_code]);
        $options1 = [
...
#status data groupjabatan_tanda
  function Status($model){
      if ($model->groupjabatan_tanda == 1 || $model->groupjabatan_tanda == 2 ){
            return html::label('<span class="fa fa-check fa-1x"></span>','',['style'=>['color'=>'green']]);
        }else if($model->groupjabatan_tanda == 3){
            return html::label('<span class="fa fa-times fa-1x"></span>','',['style'=>['color'=>'red']]);
       }
  }

/**
 * GRID Hr jobgroupjabatan
...
$headColomnBT=[
    ...
    ['ID' =>2, 'ATTR' =>['FIELD'=>'groupjabatan_name','SIZE' => '30px','label'=>'group jabatan','align'=>'left','warna'=>'73, 162, 182, 1','grp'=>false]],
    ['ID' =>3, 'ATTR' =>['FIELD'=>'groupjabatan_code','SIZE' => '30px','label'=>'group jabatan code','align'=>'left','warna'=>'73, 162, 182, 1','grp'=>false]],
    ['ID' =>4, 'ATTR' =>['FIELD'=>'groupjabatan_tanda','SIZE' => '30px','label'=>'Link Website','align'=>'left','warna'=>'73, 162, 182, 1','grp'=>false]],
    ];
...
foreach($gvHeadColomnBT as $key =>$value[]){
  ...
  if($value[$key]['FIELD'] == 'groupjabatan_tanda')
  {
    $attDinamik[]=[
...
?>
<div class="hr-jobgroupjabatan-index">
...
<?= $grid_jobgroup=GridView::widget([
    'id'=>'gv-hr-job-group-id',
    'dataProvider' => $dataProvider,
