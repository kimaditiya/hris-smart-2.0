...
/* @var $searchModel backend\master\models\HrJobgradeSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Hr Jobgrade';
...
/*
  ...
  */
  function tombolView($url, $model){
        ...
        $label = $icon . ' ' . $title;
        $url = Url::toRoute(['/master/hr-group/view','id'=>$model->grade_id]);
        $options1 = [
                    'id'=>'view-hrgroup-id',   
                    'data-toggle'=>"modal",
...
/*
  ...
  */
  function tombolUpdate($url, $model){
        ...
        $label = $icon . ' ' . $title;
        $url = Url::toRoute(['/master/hr-group/update','id'=>$model->grade_id]);
        $options1 = [
...
#status data grade_tanda
  function Status($model){
      if ($model->grade_tanda == 1 || $model->grade_tanda == 2 ){
            return html::label('<span class="fa fa-check fa-1x"></span>','',['style'=>['color'=>'green']]);
        }else if($model->grade_tanda == 3){
...
$headColomnBT=[
    ...
    ['ID' =>1, 'ATTR' =>['FIELD'=>'namePangkat','SIZE' => '30px','label'=>'Job Level','align'=>'left','warna'=>'73, 162, 182, 1','grp'=>true]],
    ['ID' =>2, 'ATTR' =>['FIELD'=>'grade_value','SIZE' => '30px','label'=>'Grade Value','align'=>'left','warna'=>'73, 162, 182, 1','grp'=>true]],
    ['ID' =>3, 'ATTR' =>['FIELD'=>'grade_tanda','SIZE' => '30px','label'=>'status','align'=>'left','warna'=>'73, 162, 182, 1','grp'=>false]],
    ];
...
foreach($gvHeadColomnBT as $key =>$value[]){
  ...
  if($value[$key]['FIELD'] == 'grade_tanda')
  {
    $attDinamik[]=[
